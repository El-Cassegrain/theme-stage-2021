...
<div class="container hero-wrapper">
    <div class="row flex-lg-row-reverse justify-content-md-center">
        ...
        <div class="col-12 col-md-8 col-lg-6 mt-5 pt-4 pt-md-0">
            ...
            <h1 class="hero-title font-title violet">Stage d'application professionnelle</h1>
            ...
            <div class="row my-5">
                <div class="col-12">
                    <a href="#!" class="btn btn-primary btn-lg waves-effect waves-light d-block d-sm-inline-flex btn-rapport-1 ml-md-0"><i class="material-icons star-icon">star</i>Voir le rapport de lancement</a>
                </div>
